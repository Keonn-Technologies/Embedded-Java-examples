...
$JAVA -Dcom.keonn.os.io.SampleDelay=1000 -Dcom.keonn.os.io.SamplePeriod=30 -Dcom.keonn.system.defs=adrd-150-series -Dcom.keonn.system.model=0091103 -Dgnu.io.rxtx.SerialPorts=/dev/ttyO1:/dev/ttyO4 -Djava.library.path=native-lib \
